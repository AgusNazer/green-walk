    ...
    <div className="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl xl:px-32">
      <div className="grid items-center lg:grid-cols-2">
        <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
          <div
            ...
            <h1 className="mt-2 mb-16 text-4xl font-bold tracking-tight md:text-5xl xl:text-6xl">
              Empieza a <br /><span className="text-primary">ganar recompensas y ayudar al planeta</span>
            </h1>
        ...
        <div className="md:mb-12 lg:mb-0">
          <img src="https://images.unsplash.com/photo-1587573578335-9672da4d0292?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
export default HeroInformative