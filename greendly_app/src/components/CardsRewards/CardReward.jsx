...
const Card = () => {
  ...
  return (
    <View className="relative flex-1 flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 ">
      ...
      <View className="p-6">
        <Text className="block text-center mb-2 font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
        Tokens Earned
        </Text>
        <Text className="block text-xl font-semibold text-center font-sans  antialiased  leading-relaxed text-inherit">
            250 Greens
        </Text>
      </View>
      <View className="p-6 pt-0">
        <TouchableOpacity onPress={test} className="align-middle w-full select-none font-sans  font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none">
